    ...
    public class ProfileController : ControllerBase
    {
        ...
        public async Task<ActionResult<object[]>> GetValues()
        {
            ...
            return await _context.Profiles
                ...
                .Select(a => new object[]{ a.PlayerName, a.PopnFriendId, a.UseCharacterName,
                    a.NormalModeCreditCount, a.BattleModeCreditCount, a.LocalModeCreditCount, a.Comment, a.LastUpdateTime.ToString("s") })
                .ToArrayAsync();
        }
    }
}
